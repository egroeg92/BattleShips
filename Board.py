        ...
        for x in range(30):
            for y in range(30):
                ...
                if (sonarVisibility):
                    if(obj == None):
                        if self.tick == 0:
                            surface.blit(pygame.image.load('images/sonarwater1.png').convert(),(x*20 + x*1 + d ,y*20 + y*1 + 10))
                        else:
                            surface.blit(pygame.image.load('images/sonarwater2.png').convert(),(x*20 + x*1 + d ,y*20 + y*1 + 10))
                    ...
                    if (obj.positionIndex((x,y)) == 0 and obj.getSubclass() != "Kamikaze"):
                        if (obj.getOrientation() == "E"):
                            ...
                            if (obj.isSelected()):
                                ...
                                if player1:
                                    surface.blit(pygame.image.load('images/P1FN.png').convert(),(x*20 + x*1 + d, y*20 + y*1 + 10))
                                else:
